...
标记含义见 `../SKILL.md` §二。原文记录的实测时间为 2026-09-01，中国大陆网络，无代理；这是历史记录，本次没有逐项重新验证。匿名访问、速率限制和地域可达性可能变化，不能把 `[OK]` 或“无限速”视为持续承诺。自带探活仅覆盖 `scripts/probe_sources.py --list` 列出的五个来源。
